	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
		    <div class="container-xl">
			    ...
			    <div class="row g-3 mb-4 align-items-center justify-content-between">
				    <div class="col-auto">
			            <h1 class="app-page-title mb-0">Prestasi</h1>
				    </div>
				    <div class="col-auto">
			    ...
			    <nav id="orders-table-tab" class="orders-table-tab app-nav-tabs nav shadow-sm flex-column flex-sm-row mb-4">
				    ...
				    <a class="flex-sm-fill text-sm-center nav-link"  id="orders-paid-tab" data-bs-toggle="tab" href="#orders-paid" role="tab" aria-controls="orders-paid" aria-selected="false">Akademik</a>
				    <a class="flex-sm-fill text-sm-center nav-link" id="orders-pending-tab" data-bs-toggle="tab" href="#orders-pending" role="tab" aria-controls="orders-pending" aria-selected="false">Non-Akademik</a>
				</nav>
							        ...
							        <table class="table app-table-hover mb-0 text-left">
										...
										<tbody>
											...
											@else
												...
												<tr>
													<td colspan="4" class="cell text-center pt-5 pb-5"><h4>Prestasi tidak ditemukan</h4></td>
												</tr>
							    ...
							    <div class="table-responsive">
							        <table class="table mb-0 text-left">
										...
										<tbody>
											...
											@foreach($dataNonAkademik as $data)
