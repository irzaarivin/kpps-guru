<div class="position-relative mb-3">
				    <div class="row g-3 justify-content-between">
					    ...
					    <script>
							...
							function keDetail(id) {
								return $('#kolomPermit').load('http://kpps.test/permit-detail?id=' + id);
							}
				...
				@if($permit->count())
	                ...
	                <div class="app-card app-card-notification shadow-sm mb-4">
					    ...
					    <div class="app-card-footer px-4 py-3">
						    <button class="btn app-btn-primary" onclick="return keDetail({{ $data->id }});">Lebih Jelas<svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-arrow-right ms-2" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
