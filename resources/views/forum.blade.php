...
@section('content')
    ...
    <div class="app-wrapper">
	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4 mb-5">
		    <div style="margin-bottom: 100px;" class="container-xl" id="kolomChat">
				    ...
				    <div class="row g-3 justify-content-between">
					    ...
					    <div class="col-auto">
					        <div class="page-utilities">
					        	<button class="btn app-btn-secondary my-4" onclick="return refreshHalaman();"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-clockwise" viewBox="0 0 16 16">
  ...
  <path d="M11 1.5v1h3.5a.5.5 0 0 1 0 1h-.538l-.853 10.66A2 2 0 0 1 11.115 16h-6.23a2 2 0 0 1-1.994-1.84L2.038 3.5H1.5a.5.5 0 0 1 0-1H5v-1A1.5 1.5 0 0 1 6.5 0h3A1.5 1.5 0 0 1 11 1.5Zm-5 0v1h4v-1a.5.5 0 0 0-.5-.5h-3a.5.5 0 0 0-.5.5ZM4.5 5.029l.5 8.5a.5.5 0 1 0 .998-.06l-.5-8.5a.5.5 0 1 0-.998.06Zm6.53-.528a.5.5 0 0 0-.528.47l-.5 8.5a.5.5 0 0 0 .998.058l.5-8.5a.5.5 0 0 0-.47-.528ZM8 4.5a.5.5 0 0 0-.5.5v8.5a.5.5 0 0 0 1 0V5a.5.5 0 0 0-.5-.5Z"/>
		    ...
		    <form action="/forum" method="POST" class="text-white fixed-bottom shadow-lg" id="kirimPesan" style="background-color: #F5F6FE;">
		    	 <div class="input-group p-3">
		    	 	@csrf
				   <input type="text" class="form-control" placeholder="Isi pesan..." id="isi" name="isi" autocomplete="off" autofocus>
				   <button style="background-color: blue; color: white;" class="btn" id="kirim" type="submit"><i class="bi bi-send-fill" style="color: white;"></i></button>
				 </div>
		    </form>
